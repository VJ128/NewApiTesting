...
public class POST_User_Scenario10_SameEmailID {
	...
	public void postWithSameEmailID() {
		try {
			...
			Assert.assertTrue(respStrng.contains("has already been taken"));
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
